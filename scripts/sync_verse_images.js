/**
 * DailyVerse — VERSE_IMAGES 시트 + 로컬 파일 → Firebase Storage + Firestore 동기화
 *
 * 동작 방식:
...
async function main() {
  console.log('\n📊 Google Sheets VERSE_IMAGES 탭 읽는 중...');
