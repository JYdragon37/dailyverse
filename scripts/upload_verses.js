 ...
 * v5.1: 새벽 모드, cooldown 필드, is_sacred_safe, text_position 등 신규 필드 반영
...
const verses = [
  ...
  },
  {
    ...
    mode: ["evening"], theme: ["peace", "rest"], mood: ["calm", "cozy"],
    season: ["all"], weather: ["rainy", "cloudy"],
  ...
  },
  {
    ...
    mode: ["dawn", "morning"], theme: ["stillness", "grace"], mood: ["serene", "calm"],
    season: ["all"], weather: ["any"],
