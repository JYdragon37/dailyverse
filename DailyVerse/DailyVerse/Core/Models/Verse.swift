...
struct Verse: Identifiable, Codable, Equatable, Hashable {
    ...
    static let fallbackFirstLight = Verse(
        ...
        textKo: "여호와여 아침에 주께서 나의 소리를 들으시리니",
        textFullKo: "여호와여 아침에 주께서 나의 소리를 들으시리니 아침에 내가 주께 기도하고 바라리이다",
        reference: "시편 5:3",
    ...
    static let fallbackPeakMode = Verse(
        ...
        textKo: "내가 능력 주시는 자 안에서 모든 것을 할 수 있느니라",
        textFullKo: "내가 비천에 처할 줄도 알고 풍부에 처할 줄도 알아 모든 일 곧 배부름과 배고픔과 풍부와 궁핍에도 처할 줄 아는 일체의 비결을 배웠노라 내가 능력 주시는 자 안에서 모든 것을 할 수 있느니라",
        reference: "빌립보서 4:13",
    ...
    static let fallbackSecondWind = Verse(
        ...
        textKo: "담대하라 내가 세상을 이기었노라",
        textFullKo: "세상에서는 너희가 환난을 당하나 담대하라 내가 세상을 이기었노라 이것을 너희에게 이르는 것은 너희로 내 안에서 평안을 누리게 하려 함이라",
    ...
    static let fallbackWindDown = Verse(
        ...
        textKo: "너희 염려를 다 주께 맡기라",
        textFullKo: "너희 염려를 다 주께 맡기라 이는 그가 너희를 돌보심이라",
        reference: "베드로전서 5:7",
