...
**목적**: 핵심 리텐션 행동(알람 설정)을 온보딩에서 완료. 권한 요청을 감정적으로 프레이밍.
...
|----|-----------|----------------|
| **Calm** | Value-first (직접 체험 후 개인화) | Screen 2에서 실제 말씀카드 체험 먼저 |
| **Calm** | 감정적 공감 질문 "지금 어떤가요?" | Screen 3 "지금 필요한 말씀은?" |
| **Headspace** | 목적/테마 선택으로 개인화 | 테마 그리드 선택 (용기/평안/지혜...) |
| **Abide** | 기도/묵상 앱 특화 - 조용한 인트로 | 파티클 효과로 성스러운 분위기 |
| **YouVersion** | 알람/리마인더를 핵심 CTA로 | Screen 4에서 알람 설정을 핵심 완료 행동으로 |
| **Duolingo** | 중간에 보상 감각 주기 | Screen 2에서 "오늘의 말씀" 미리보기로 즉각적 가치 |
